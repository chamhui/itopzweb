...
Partial Class Agent_Reload
	...
	Private Function InsertIntoTxIn(ByVal sMSISDN As String, ByVal sMOMsg As String, ByVal sMOTS As String) As Boolean
		...
		Try
			...
			getsReloadAmount(sReloadAmount, sReloadTelco, oConn, sReloadAmount)
			If sAgentId = "" Then
				bValid = False
			...
			If (DDLTelco.SelectedValue = "STARHUB DATA") Then

				If (DDLReloadAmount.SelectedValue = "2") Then
					sMOMsg = txtReloadMSISDN.Text & ".HD1"
					sReloadAmount = "2"
				End If
				If (DDLReloadAmount.SelectedValue = "4") Then
					sMOMsg = txtReloadMSISDN.Text & ".HD2"
					sReloadAmount = "4"
				End If
				If (DDLReloadAmount.SelectedValue = "7") Then
					sMOMsg = txtReloadMSISDN.Text & ".HD3"
					sReloadAmount = "7"
				End If
				If (DDLReloadAmount.SelectedValue = "15") Then
					sMOMsg = txtReloadMSISDN.Text & ".HD4"
					sReloadAmount = "15"
				End If
				If (DDLReloadAmount.SelectedValue = "20") Then
					sMOMsg = txtReloadMSISDN.Text & ".HD5"
					sReloadAmount = "20"
				End If
				If (DDLReloadAmount.SelectedValue = "1") Then
					sMOMsg = txtReloadMSISDN.Text & ".HD6"
					sReloadAmount = "1"
				End If
				If (DDLReloadAmount.SelectedValue = "5") Then
					sMOMsg = txtReloadMSISDN.Text & ".HD7"
					sReloadAmount = "5"
				End If
				If (DDLReloadAmount.SelectedValue = "10") Then
					sMOMsg = txtReloadMSISDN.Text & ".HD8"
					sReloadAmount = "10"
				End If
			End If
	...
	Private Function getsReloadAmount(ByVal sDeno As String, ByVal p_telco As String, ByVal oConn As SqlConnection, ByRef sReloadAmount As Integer) As Integer
		...
		Try
			...
			oCmd = oConn.CreateCommand
			oCmd.Connection = oConn
			sSQL = "SELECT * FROM ProductDetails WHERE P_Deno=@P_Deno and P_Telco=@P_Telco "
