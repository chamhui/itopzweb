...
Partial Class Agent_Reload4Data
	...
	'        lblReloadAmount.Text = "SGD 50"
	'    End If
	'    If (rb16.Checked = True) Then
	'        lblReloadAmount.Text = "SGD 16"
	'    End If
	'    If (rb15.Checked = True) Then
	'        lblReloadAmount.Text = "SGD 15"
	'    End If
	'    If (rb28.Checked = True) Then
	'        lblReloadAmount.Text = "SGD 28"
	'    End If
	'    If (rb300.Checked = True) Then
	'        lblReloadAmount.Text = "SGD 30"
	'    End If
	'    If (rb180.Checked = True) Then
	'        lblReloadAmount.Text = "SGD 18"
	'    End If
	'    If (rb888.Checked = True) Then
	'        lblReloadAmount.Text = "SGD 8"
	'    End If
	'    If (rb102.Checked = True) Then
	'        lblReloadAmount.Text = "SGD 7"
	'    End If
	'    If (rb1015.Checked = True) Then
	'        lblReloadAmount.Text = "SGD 10"
	'    End If
	'    If (rb118.Checked = True) Then
	'        lblReloadAmount.Text = "SGD 10"
	'    End If
	'    If (rb1315.Checked = True) Then
	'        lblReloadAmount.Text = "SGD 13"
	'    End If
	'    If (rb119.Checked = True) Then
	'        lblReloadAmount.Text = "SGD 20"
	'    End If
	'    If (rb2504.Checked = True) Then
	'        lblReloadAmount.Text = "SGD 25"
	'    End If
	'    If (rb120.Checked = True) Then
	'        lblReloadAmount.Text = "SGD 30"
	'    End If


	'    Me.lblReloadAmount.Text = "Amount: " & lblReloadAmount.Text
	'    Me.lblReloadTelco.Text = "Telco : SINGTEL"
	...
	'    If (rb5.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb5.ID.ToString().Remove(0, 2)

	'    End If
	'    If (rb10.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb10.ID.ToString().Remove(0, 2)
	'        sAmount = "10"
	'    End If
	'    If (rb20.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb20.ID.ToString().Remove(0, 2)
	'        sAmount = "20"
	'    End If
	'    If (rb50.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb50.ID.ToString().Remove(0, 2)
	'        sAmount = "50"
	'    End If
	'    If (rb16.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb16.ID.ToString().Remove(0, 2)
	'        sAmount = "16"
	'    End If
	'    If (rb15.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb15.ID.ToString().Remove(0, 2)
	'        sAmount = "15"
	'    End If
	'    If (rb28.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb28.ID.ToString().Remove(0, 2)
	'        sAmount = "28"
	'    End If
	'    If (rb300.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb300.ID.ToString().Remove(0, 2)
	'        sAmount = "30"
	'    End If
	'    If (rb180.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb180.ID.ToString().Remove(0, 2)
	'        sAmount = "18"
	'    End If
	'    If (rb888.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb888.ID.ToString().Remove(0, 2)
	'        sAmount = "8"
	'    End If
	'    If (rb102.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb102.ID.ToString().Remove(0, 2)
	'        sAmount = "7"
	'    End If
	'    If (rb1015.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb1015.ID.ToString().Remove(0, 2)
	'        sAmount = "10"
	'    End If
	'    If (rb118.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb118.ID.ToString().Remove(0, 2)
	'        sAmount = "10"
	'    End If
	'    If (rb1315.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb1315.ID.ToString().Remove(0, 2)
	'        sAmount = "13"
	'    End If
	'    If (rb119.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb119.ID.ToString().Remove(0, 2)
	'        sAmount = "20"
	'    End If
	'    If (rb2504.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb2504.ID.ToString().Remove(0, 2)
	'        sAmount = "25"
	'    End If
	'    If (rb120.Checked = True) Then
	'        sMsg = txtReloadMSISDN.Text & " " & rb120.ID.ToString().Remove(0, 2)
	'        sAmount = "30"
	'    End If
