<%@ Page Language="VB"  MasterPageFile="~/Site.Master"  AutoEventWireup="false" Inherits="WebItopz.Agent_ReloadIndia" title="India - Flexiload" Codebehind="Agent_ReloadIndia.aspx.vb" %>
...
&nbsp;<img src="images/loading.gif" /> 
 ...
 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="INDIAFlexi" Name="Status" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
