<%@ Page Language="VB"  MasterPageFile="~/Site.Master"  AutoEventWireup="false" Inherits="WebItopz.Agent_Reload_Receive" title="Agent - Reload" Codebehind="Agent_Reload_Receive.aspx.vb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="x_panel" style="font-size: 23px;">
        <div class="x_title">
        <h2>Reload</h2>
        ...
        <div class="form-horizontal form-label-left" >                   
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
									<asp:TextBox ID="txtTelco" runat="server" Enabled="false"></asp:TextBox>
            ...
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
									<asp:TextBox ID="txtReloadAmount" runat="server" Enabled="false"></asp:TextBox>
									<asp:TextBox ID="txtdeno" runat="server" Visible="false"></asp:TextBox>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtReloadMSISDN" runat="server" class="" ></asp:TextBox>
                </div>
            ...
            <div class="item form-group col-md-7 col-sm-7 col-xs-12" style="text-align:center;">
							<a class="btn btn-success" href="Agent_Reload2.aspx">Back</a>
							...
							<asp:Button id="btnEdit" runat="server" Text="Edit" Visible="False" cssClass="btn displaynone" ></asp:Button>
