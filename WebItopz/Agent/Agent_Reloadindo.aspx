<%@ Page Language="VB"  MasterPageFile="~/Site.Master"  AutoEventWireup="false" Inherits="WebItopz.Agent_Reloadindo" title="Indo - Reload" Codebehind="Agent_Reloadindo.aspx.vb" %>
...
&nbsp;<img src="images/loading.gif" /> 
  ...
  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="INDOFlexi" Name="Status" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>