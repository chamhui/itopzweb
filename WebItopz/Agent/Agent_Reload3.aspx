<%@ Page Language="VB"  MasterPageFile="~/Site.Master"  AutoEventWireup="false" Inherits="WebItopz.Agent_Reload3" title="Agent - Reload" Codebehind="Agent_Reload3.aspx.vb" %>
     ...
     <div class="container">
                ...
                <div class="col">
                    <a href="Agent_Reload_Receive.aspx?telco=starhub&deno=11&value=11">
                        <div class="card text-white" style="background-color: #32CD32">
                            ...
                            <div class="card-body text-center">
                                        <h3 class="card-title">Wow 1001 $11</h3>
                            </div>
                            <h5 class="card-header" style="background-color: #2F4F4F">
           ...
           <br />
                ...
                <div class="col">
               	...
               	<div class="col">
                    <a href="Agent_Reload_Receive.aspx?telco=starhub&deno=0&value=0">
                        <div class="card text-white" style="background-color: #32CD32">
