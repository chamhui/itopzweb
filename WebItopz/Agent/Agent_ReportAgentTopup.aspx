<%@ Page Language="VB"  MasterPageFile="~/Site.Master"  AutoEventWireup="false" Inherits="WebItopz.Agent_ReportAgentTopup" title="ReportAgentTopup" Codebehind="Agent_ReportAgentTopup.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0;">
        ...
        SelectCommand="SELECT CONVERT (varchar(10), t.CreatedTS, 111) AS Date, SUM(t.Amount) AS Amount, t.AgentID, i.Name FROM AgentTopupTx AS t INNER JOIN AgentInfo AS i ON t.AgentID = i.AgentID WHERE (DATEPART(mm, t.CreatedTS) = @month) AND (DATEPART(yyyy, t.CreatedTS) = @year) AND (DAY(t.CreatedTS) = @Day) AND (t.AgentID  = @agentid) GROUP BY CONVERT (varchar(10), t.CreatedTS, 111), t.AgentID, i.Name">
        <SelectParameters>
