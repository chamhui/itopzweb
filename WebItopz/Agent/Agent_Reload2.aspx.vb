...
Partial Class Agent_Reload2
	...
	'            lblReloadAmount.Text = "SGD" & rb2.ID.ToString().Remove(0, 2)
	'        End If
	'        If (rb5.Checked = True) Then
	'            lblReloadAmount.Text = "SGD" & rb5.ID.ToString().Remove(0, 2)
	'        End If
	'        If (rb10.Checked = True) Then
	'            lblReloadAmount.Text = "SGD" & rb10.ID.ToString().Remove(0, 2)
	'        End If
	'        If (rb15.Checked = True) Then
	'            lblReloadAmount.Text = "SGD" & rb15.ID.ToString().Remove(0, 2)
	'        End If
	'        If (rb18.Checked = True) Then
	'            lblReloadAmount.Text = "SGD" & rb18.ID.ToString().Remove(0, 2)
	'        End If
	'        If (rb19.Checked = True) Then
	'            lblReloadAmount.Text = "SGD" & rb19.ID.ToString().Remove(0, 2)
	'        End If
	'        If (rb20.Checked = True) Then
	'            lblReloadAmount.Text = "SGD" & rb20.ID.ToString().Remove(0, 2)
	'        End If
	'        If (rb28.Checked = True) Then
	'            lblReloadAmount.Text = "SGD" & rb28.ID.ToString().Remove(0, 2)
	'        End If
	'        If (rb30.Checked = True) Then
	'            lblReloadAmount.Text = "SGD" & rb30.ID.ToString().Remove(0, 2)
	'        End If
	...
	'    Me.lblReloadTelco.Text = "Telco : M1"
	...
	'	'Dim sMsg As String = ""
	'	'If (rbOther.Checked = True) Then
	'	'    sMsg = txtReloadMSISDN.Text & " " & txtAmount.Text

	'	'Else
	'	'    If (rb2.Checked = True) Then
	'	'        sMsg = txtReloadMSISDN.Text & " " & rb2.ID.ToString().Remove(0, 2)
	'	'    End If
	'	'    If (rb5.Checked = True) Then
	...
	'	'    End If
	'	'    If (rb18.Checked = True) Then
	'	'        sMsg = txtReloadMSISDN.Text & " " & rb18.ID.ToString().Remove(0, 2)
	'	'    End If
	'	'    If (rb19.Checked = True) Then
	'	'        sMsg = txtReloadMSISDN.Text & " " & rb19.ID.ToString().Remove(0, 2)
	'	'    End If
	'	'    If (rb20.Checked = True) Then
	...
	'	'    End If
	'	'    If (rb30.Checked = True) Then
	'	'        sMsg = txtReloadMSISDN.Text & " " & rb30.ID.ToString().Remove(0, 2)
	'	'    End If
