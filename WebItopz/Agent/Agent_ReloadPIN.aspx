<%@ Page Language="VB"  MasterPageFile="~/Site.Master"  AutoEventWireup="false" Inherits="WebItopz.Agent_ReloadPIN" title="Agent - Reload" Codebehind="Agent_ReloadPIN.aspx.vb" %>
...
&nbsp;<img src="images/loading.gif" /> 
 ...
 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
        ...
        SelectCommand="SELECT Telco FROM ProductInfo WHERE (Status = @Status) AND (Telco   LIKE '%PIN')  ">
        <SelectParameters>
