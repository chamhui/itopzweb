...
Partial Class Agent_Reloadindo
	...
	Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
		...
		If Me.txtReloadMSISDN.Text = "" Or Me.txtReloadMSISDN.Text.Length < 10 Then
		...
		Else
			...
			Me.lblReloadAmount.Text = "Rp " & DDLReloadAmount.Text & ",000"
			Me.lblReloadTelco.Text = GetPrefix(txtReloadMSISDN.Text)
	...
	Private Function InsertIntoTxIn(ByVal sMSISDN As String, ByVal sMOMsg As String, ByVal sMOTS As String) As Boolean
		...
		Try
			...
			If UBound(aMOMsg) = 1 Then
				...
				sReloadTelco = Me.DDLTelco.SelectedValue 'GetPrefix(sReloadMSISDN)
