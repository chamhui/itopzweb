<%@ Page Language="VB"  MasterPageFile="~/Site.Master"  AutoEventWireup="false" Inherits="WebItopz.Agent_Reload3Data" title="Agent - Reload" Codebehind="Agent_Reload3Data.aspx.vb" %>
...
.far{
    ...
    <div class="x_panel">
     <div class="container">
            ...
            <div class="row">
                <div class="col">
                  <a href="Agent_Reload_Receive.aspx?telco=starhubdata&deno=1&value=2">
                ...
                <div class="col">
                    <a href="Agent_Reload_Receive.aspx?telco=starhubdata&deno=2&value=6">
                        <div class="card text-white" style="background-color: #32CD32">
                
                            <div class="card-body text-center">
                
                               <h3 class="card-title">3Days 1GB $4</h3>
                ...
                <div class="col">
                     <a href="Agent_Reload_Receive.aspx?telco=starhubdata&deno=3&value=8">
                        <div class="card text-white" style="background-color: #32CD32">
                
                            <div class="card-body text-center">
                
                                <h3 class="card-title">7Days 1GB $8</h3>
                ...
                <div class="col">
                         <a href="Agent_Reload_Receive.aspx?telco=starhubdata&deno=4&value=11">
                        <div class="card text-white" style="background-color: #32CD32">
                
                            <div class="card-body text-center">
                
                                <h3 class="card-title">30Days 1GB $11</h3>
            ...
            <div class="row">
                <div class="col">
                        <a href="Agent_Reload_Receive.aspx?telco=starhubdata&deno=5&value=18">
                        <div class="card text-white" style="background-color: #32CD32">
                
                            <div class="card-body text-center">
                
                                <h3 class="card-title">30Days 3GB $18</h3>
                ...
                <div class="col">
                          <a href="Agent_Reload_Receive.aspx?telco=starhubdata&deno=6&value=25">
                        <div class="card text-white" style="background-color: #32CD32">
                
                            <div class="card-body text-center">
                
                                <h3 class="card-title">30Days 5GB $25</h3>
                ...
                <div class="col"  style="display:none;">
                        <a href="Agent_Reload_Receive.aspx?telco=starhubdata&deno=7&value=5">
                        <div class="card text-white" style="background-color: #32CD32">
                ...
                <div class="col"  style="display:none;">
                        <a href="Agent_Reload_Receive.aspx?telco=starhubdata&deno=8&value=10">
                        <div class="card text-white" style="background-color: #32CD32">
