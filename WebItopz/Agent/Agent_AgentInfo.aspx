<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" Inherits="WebItopz.Agent_AgentInfo" title="AgentInfo" Codebehind="Agent_AgentInfo.aspx.vb" %>
...
<script language="javascript">
   ...
   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
        ...
        OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT AgentID, Name, Status, HPNo, ParentAgentID, CreatedDate FROM AgentInfo WHERE (AgentID = @agentid) ORDER BY CreatedDate DESC"
        
        
        
        UpdateCommand="UPDATE AgentInfo SET Name = @Name, Status = @Status, HPNo = @HPNo WHERE (AgentID = @original_AgentID)">
        <DeleteParameters>
