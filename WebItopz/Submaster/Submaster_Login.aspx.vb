...
Partial Class Submaster_Login
	...
	Protected Sub LoginButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LoginButton.Click
		...
		If Session("LOGIN_FAIL_COUNT") > 3 Or isBanIP Then
			...
			Me.lblError.Visible = True
		Else
			If Me.txtMISISN.Text.Length < 8 Or Me.txtMISISN.Text.Length > 8 Then
			...
			Else
				If isValidLogin("65" & txtMISISN.Text, txtPassword.Text) Then
					If Request.ServerVariables("HTTP_REFERER").ToUpper.Contains("LOGIN") Then
						Response.Redirect("~/submaster/submaster_Search.aspx")
					Else
						Response.Redirect("~/submaster/submaster_Search.aspx")
	...
	Private Function isValidLogin(ByVal sLogin As String, ByVal sPassword As String) As Boolean
		...
		Try
			...
			sSQL = "SELECT am.AgentID, ai.Name, ai.Agentlvl FROM AgentMSISDN am , AgentInfo ai WHERE am.agentid=ai.agentid AND am.MSISDN=@MSISDN AND am.PASSWORD=@PASSWORD AND am.STATUS=@STATUS and ai.ParentAgentID=0"
