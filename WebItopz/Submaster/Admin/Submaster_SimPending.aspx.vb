...
Partial Class Submaster_Admin_SimPending
	Inherits System.Web.UI.Page
	Private Const STATUS_SUCCESS = "SUCCESS"
	Private Const STATUS_REFUNDED = "REFUNDED"
	Private Const MT_MSG = "INDO.LOAD RP<Amount>,000 to <Remarks> SUCCESS! <DateTime>."
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		If sID <> "" Then
			...
			If bWorking Then
				If Request("action").ToUpper = "RETRY" Then
					If oCommon.Retry(sID) Then
				...
				ElseIf Request("action").ToUpper = "SUCCESS" Then
					If oCommon.Success(sID) Then
						If oCommon.SuccessToAgent(sID) Then
	...
	'            'Private Const MT_MSG = "Starhub Top-Up $ [<Amount>] to <Remarks> SUCCESS! DateTime:<DateTime>."
