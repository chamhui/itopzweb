<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="Submaster_ReportSales.aspx.vb" Inherits="WebItopz.Submaster_Admin_ReportSales" title="ReportSales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0;">
        <div class="x_panel">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" OnPreRender="GridView1_PreRender"
                DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical" BackColor="White" 
                BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" style="width: 100%;" CssClass="datatable-responsive table table-striped table-bordered dt-responsive">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                SelectCommand="SELECT CONVERT (char(10), CreatedTS, 111) AS Date, SUM(ReloadAmount) AS TotalSales FROM TxIn WHERE ((Status = 'SUCCESS') OR STATUS='PENDING') and datepart(mm,createdts)=@month and datepart(yyyy,createdts)=@year&#13;&#10;GROUP BY CONVERT (char(10), CreatedTS, 111)&#13;&#10;ORDER BY CONVERT (char(10), CreatedTS, 111)">
                <SelectParameters>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12" style="padding-right: 0;">
        <div class="x_panel">
            ...
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" OnPreRender="GridView2_PreRender"
                DataSourceID="SqlDataSource2" ForeColor="Black" GridLines="Vertical" BackColor="White" 
                BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CssClass="datatable-responsive table table-striped table-bordered dt-responsive">
                <FooterStyle BackColor="#CCCC99" />
                <Columns>
                    <asp:BoundField DataField="Date" HeaderText="Date" SortExpression="Date" />
                    <asp:BoundField DataField="TotalSales" HeaderText="TotalSales" SortExpression="TotalSales" />
                ...
                <SelectedRowStyle BackColor="#CE5D5A" Font-Bold="True" ForeColor="White" />
                <PagerStyle ForeColor="#333333" HorizontalAlign="Left" CssClass="GridPager" />
                <HeaderStyle BackColor="#404040" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                <AlternatingRowStyle BackColor="White" />
            </asp:GridView>
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                SelectCommand="select convert(char(10),createdts,111) Date, sum(ReloadAmount) TotalSales from DNReceived&#13;&#10;where DNStatus='SUCCESS' and datepart(mm,createdts)=@month and datepart(yyyy,createdts)=@year&#13;&#10;group by convert(char(10),createdts,111)&#13;&#10;order by convert(char(10),createdts,111) ">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DDLMonth" Name="month" PropertyName="SelectedValue" />
                    <asp:ControlParameter ControlID="DDLYear" Name="year" PropertyName="SelectedValue" />
                </SelectParameters>
