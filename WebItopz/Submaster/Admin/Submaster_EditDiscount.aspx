<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="Submaster_EditDiscount.aspx.vb" Inherits="WebItopz.Submaster_EditDiscount" %>
...
<script language="javascript">
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" style="width:100% !important;"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Rebate">
                    <ItemTemplate>
                    <a href="javascript:openPopup('<%# Eval("ProductID", "Submaster_EditAgentRebate.aspx?ProductID={0}&") %>AgentID=<%# Eval("AgentID") %>')">View/Edit</a>
                    </ItemTemplate>
                </asp:TemplateField>                  
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
            ...
            OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT AgentProduct.ID, AgentProduct.AgentID, ProductInfo.Telco, AgentProduct.Discount, AgentProduct.Status, AgentProduct.ProductID FROM AgentProduct INNER JOIN ProductInfo ON AgentProduct.ProductID = ProductInfo.ProductID WHERE (AgentProduct.AgentID = @AgentID)"
