...
Partial Class Submaster_Admin_Redo
	...
	'            sSQL = "UPDATE TxIn SET retry = 0,SIMBalanceDeducted='NO' " & _
	'                   "WHERE LocalMOID=@LocalMOID "
	'        Else
	'            sSQL = "UPDATE TxIn SET retry = 0 " & _
	'                   "WHERE LocalMOID=@LocalMOID "
	'        End If
	...
	'    Try
	'        Success = False
	'        sSQL = "UPDATE TxIn SET Status='SUCCESS'  " & _
	'               "WHERE LocalMOID=@LocalMOID "
