<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="Submaster_PrintReportAgentSalesAll.aspx.vb" Inherits="WebItopz.Submaster_PrintReportAgentSalesAll" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>" SelectCommand="SELECT MSISDN, AgentID, ReloadTelco, DNReceivedID, Status, ReloadAmount, ReloadMSISDN, CreatedTS FROM TxIn WHERE (REPLACE(CONVERT (char(10), CreatedTS, 111), '/', '') >= @CreatedTS) AND (REPLACE(CONVERT (char(10), CreatedTS, 111), '/', '') <= @CreatedTS2) AND AgentID in (SELECT [AgentID] FROM [AgentInfo] WHERE (Agentlvl like @Agentlvl & @Agentid & '|%'))">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
            SelectCommand="SELECT Sum(ReloadAmount) as ToTal  FROM [TxIn] WHERE (REPLACE(CONVERT (char(10), CreatedTS, 111), '/', '') >= @CreatedTS) AND (REPLACE(CONVERT (char(10), CreatedTS, 111), '/', '') <= @CreatedTS2) and Status='SUCCESS' AND AgentID in (SELECT [AgentID] FROM [AgentInfo] WHERE (Agentlvl like @Agentlvl & @Agentid & '|%'))">
            <SelectParameters>
							<asp:SessionParameter Name="Agentid" SessionField="AGENT_ID" />
						   <asp:SessionParameter Name="Agentlvl" SessionField="AGENT_AGENTLVL" />
                <asp:ControlParameter ControlID="txtDateFrom" Name="CreatedTS" PropertyName="Text" />
        ...
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
            SelectCommand="SELECT Sum(ReloadAmount) as ToTal  FROM [TxIn] WHERE (REPLACE(CONVERT (char(10), CreatedTS, 111), '/', '') >= @CreatedTS) AND (REPLACE(CONVERT (char(10), CreatedTS, 111), '/', '') <= @CreatedTS2) and Status='REFUNDED' AND AgentID in (SELECT [AgentID] FROM [AgentInfo] WHERE (Agentlvl like @Agentlvl & @Agentid & '|%'))">
            <SelectParameters>
							<asp:SessionParameter Name="Agentid" SessionField="AGENT_ID" />
						   <asp:SessionParameter Name="Agentlvl" SessionField="AGENT_AGENTLVL" />
                <asp:ControlParameter ControlID="txtDateFrom" Name="CreatedTS" PropertyName="Text" />
        ...
        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
            SelectCommand="SELECT Sum(ReloadAmount) as ToTal  FROM [TxIn] WHERE (REPLACE(CONVERT (char(10), CreatedTS, 111), '/', '') >= @CreatedTS) AND (REPLACE(CONVERT (char(10), CreatedTS, 111), '/', '') <= @CreatedTS2) and Status='CANCELLED' AND AgentID in (SELECT [AgentID] FROM [AgentInfo] WHERE (Agentlvl like @Agentlvl & @Agentid & '|%'))">
            <SelectParameters>
							<asp:SessionParameter Name="Agentid" SessionField="AGENT_ID" />
						   <asp:SessionParameter Name="Agentlvl" SessionField="AGENT_AGENTLVL" />
                <asp:ControlParameter ControlID="txtDateFrom" Name="CreatedTS" PropertyName="Text" />
        ...
        <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
            SelectCommand="SELECT Sum(ReloadAmount) as ToTal  FROM [TxIn] WHERE (REPLACE(CONVERT (char(10), CreatedTS, 111), '/', '') >= @CreatedTS) AND (REPLACE(CONVERT (char(10), CreatedTS, 111), '/', '') <= @CreatedTS2) and Status='PENDING' AND AgentID in (SELECT [AgentID] FROM [AgentInfo] WHERE (Agentlvl like @Agentlvl & @Agentid & '|%'))">
            <SelectParameters>
							<asp:SessionParameter Name="Agentid" SessionField="AGENT_ID" />
						   <asp:SessionParameter Name="Agentlvl" SessionField="AGENT_AGENTLVL" />
                <asp:ControlParameter ControlID="txtDateFrom" Name="CreatedTS" PropertyName="Text" />
