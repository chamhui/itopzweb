<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="Submaster_Redo.aspx.vb" Inherits="WebItopz.Submaster_Admin_Redo" title="Redo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPreRender="GridView1_PreRender"
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="LocalMOID" DataNavigateUrlFormatString="Redo.aspx?Id={0}&amp;Action=Redo"
                HeaderText="Redo" Text="Redo" />
            <asp:HyperLinkField DataNavigateUrlFields="LocalMOID" DataNavigateUrlFormatString="Redo.aspx?Id={0}&amp;Action=Refund"
                HeaderText="Refund" Text="Refund" />
            <asp:HyperLinkField DataNavigateUrlFields="LocalMOID" DataNavigateUrlFormatString="Redo.aspx?Id={0}&amp;Action=Cancel"
                HeaderText="Cancel" Text="Cancel" />
            <asp:HyperLinkField DataNavigateUrlFields="LocalMOID" DataNavigateUrlFormatString="Redo.aspx?Id={0}&amp;Action=Success"
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
        SelectCommand="SELECT [ReloadMSISDN], [ReloadAmount], [AgentID], [MSISDN], [MessageTS], [LastUpdatedTS], [LocalMOID], [Retry], [Status] FROM [TxIn] WHERE ([Status] = @Status) AND retry>=5 OR ([Status] = @Status and ReloadTelco='CELCOM' and retry>=1) AND (DATEDIFF(n, LastUpdatedTS, GETDATE()) > 5) order by MessageTS desc ">
        <SelectParameters>
