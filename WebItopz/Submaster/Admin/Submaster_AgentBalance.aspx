<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="Submaster_AgentBalance.aspx.vb" Inherits="WebItopz.Submaster_Admin_AgentBalance" title="AgentBalance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <Columns>
                <asp:BoundField DataField="TotalBalance" HeaderText="TotalBalance" ReadOnly="True"
                    SortExpression="TotalBalance" />
							  <asp:BoundField DataField="M5" HeaderText="M5" ReadOnly="True"
                    SortExpression="M5" />
							  <asp:BoundField DataField="M18" HeaderText="M18" ReadOnly="True"
                    SortExpression="M18" />
							  <asp:BoundField DataField="M28" HeaderText="M28" ReadOnly="True"
                    SortExpression="M28" />
            </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
        SelectCommand="SELECT SUM(Balance) AS TotalBalance, SUM(M5) as M5,SUM(M18) as M18,SUM(M28) as M28   FROM AgentBalance">
    </asp:SqlDataSource>
    &nbsp;
    <br />
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" OnPreRender="GridView1_PreRender"
        ...
        GridLines="Vertical" style="margin: 10px; width: 100%;" DataKeyNames="AgentID" PageSize="20" CssClass="datatable-responsive table table-striped table-bordered dt-responsive">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
        SelectCommand="SELECT AgentID, (SELECT Name FROM AgentInfo AS i WHERE (AgentID = b.AgentID)) AS Name, (SELECT HPNo FROM AgentInfo AS i WHERE (AgentID = b.AgentID)) AS HPNo, Balance , M5,M18,M28 FROM AgentBalance AS b ORDER BY CONVERT (INT, AgentID) ">
    </asp:SqlDataSource>
    </div>
