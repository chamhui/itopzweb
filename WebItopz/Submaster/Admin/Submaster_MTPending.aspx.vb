...
Partial Class Submaster_Admin_MTPending
			...
			If bWorking Then
				If Request("action").ToUpper = "RESENTMT" Then
					If oCommon.ResentMT(sID) Then
						Me.lblErrorMsg.Text = "Resetting MT Processor"
					Else
						' Me.lblErrorMsg.Text = "Redoing Error!!!"
					End If
				ElseIf Request("action").ToUpper = "DELETEMT" Then
					If oCommon.DeleteMT(sID) Then
						Me.lblErrorMsg.Text = "Deleted"
					Else
						Me.lblErrorMsg.Text = "Delete Error(2)!!!"
					End If
				Else
					'Me.lblErrorMsg.Text = "Delete Error(1)!!!"
				End If
			End If
		End If
	End Sub
