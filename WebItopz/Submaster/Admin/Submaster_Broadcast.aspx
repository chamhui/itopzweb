<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="Submaster_Broadcast.aspx.vb" Inherits="WebItopz.Submaster_Admin_Broadcast" title="Broadcast" %>
    ...
    <div class="x_panel">
        ...
        <div class="form-horizontal form-label-left" >                   
            ...
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <asp:TextBox  runat="server" Height="160px" id="txtMsg" class="form-control col-md-7 col-xs-12" type="text" TextMode="MultiLine"></asp:TextBox>                                                    
                </div>
            </div>
