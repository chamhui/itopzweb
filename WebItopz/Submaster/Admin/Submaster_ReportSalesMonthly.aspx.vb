...
Partial Class Submaster_Admin_ReportSalesMonthly
	...
	Protected Sub GridView3_PreRender(ByVal sender As Object, ByVal e As System.EventArgs)
		If (GridView3.Rows.Count > 0) Then
			...
			If (GridView3.BottomPagerRow IsNot Nothing) Then

				GridView3.BottomPagerRow.TableSection = TableRowSection.TableFooter
				GridView3.BottomPagerRow.Cells(0).Attributes.Add("align", "left")
