<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="Submaster_AgentInfo.aspx.vb" Inherits="WebItopz.Submaster_Admin_AgentInfo" title="AgentInfo" %>
...
<script language="javascript">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" OnPreRender="GridView1_PreRender"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Discount">
                <ItemTemplate>
                <a href="javascript:openPopup('<%# Eval("AgentID", "Submaster_EditDiscount.aspx?AgentID={0}&") %>Name=<%# Eval("Name") %>')">View/Edit</a>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
        ...
        OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT AgentID, Name, Status, HPNo, ParentAgentID, CreatedDate FROM AgentInfo WHERE (AgentID IN (SELECT AgentID FROM AgentInfo AS AgentInfo_1 WHERE (ParentAgentID = @agentid))) ORDER BY AgentID ASC "
