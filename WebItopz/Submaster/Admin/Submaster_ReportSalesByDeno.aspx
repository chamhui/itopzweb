<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="Submaster_ReportSalesByDeno.aspx.vb" Inherits="WebItopz.Submaster_ReportSalesByDeno" title="ReportSalesByDeno" %>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12" style="padding-right: 0;">
        <div class="x_panel">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                SelectCommand="SELECT month(CreatedTS) AS Month, ReloadTelco, ReloadAmount, COUNT(*) AS Qty FROM [TxIn] where month(createdts)=@month and year(CreatedTS) = @year and status = 'success' Group By ReloadTelco, ReloadAmount, month(CreatedTS) order by ReloadTelco, ReloadAmount ">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DDLYear" Name="year" PropertyName="SelectedValue" />
                        <asp:ControlParameter ControlID="DDLMonth" Name="month" PropertyName="SelectedValue" />
                </SelectParameters>
