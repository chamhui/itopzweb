...
Partial Class Submaster_Admin_CustomerSearch
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		If Request("NRIC") <> "" Then
			Me.txtNRIC.Text = Request("NRIC")
		End If
	...
	'        sSQL = "SELECT t.MSISDN, t.AgentId,t.NRIC,t.ReloadAmount,t.ReloadTelco,i.DiscountSingTel as DisSingTel, i.DiscountM1 as DisM1  FROM TxIn t, AgentInfo i WHERE t.LocalMOID=@LocalMOID and t.agentid=i.agentid"
	...
	'            sMT_MSG = sMT_MSG.Replace("<Remarks>", "Refund to (" + sNRIC + ")")
