...
Partial Class Submaster_Admin_AgentInfo
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		sSQL = "SELECT AgentID, Name, Status, HPNo, ParentAgentID, CreatedDate, LastModifiedDate, (SELECT Balance FROM AgentBalance AS i WHERE (AgentID = b.AgentID)) AS Balance FROM AgentInfo AS b WHERE (Agentlvl like '" & Session("AGENT_AGENTLVL") & Session("AGENT_ID") & "|%') "

		If Me.txtAgentid.Text <> "" Then
			sSQL = sSQL & "AND AgentID= '" & txtAgentid.Text & "'"
		Else
			'lblErrorAgentid.Text = "*"
		End If
		If Me.TxtParentid.Text <> "" Then
			sSQL = sSQL & "AND ParentAgentID= '" & TxtParentid.Text & "'"
		Else
			'lblErrorParentid.Text = "*"
		End If
