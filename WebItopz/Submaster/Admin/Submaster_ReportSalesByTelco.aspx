<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="Submaster_ReportSalesByTelco.aspx.vb" Inherits="WebItopz.Submaster_ReportSalesByTelco" title="ReportSalesByTelco" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-title">
        <div class="title_left">
            <h3>Report Sales by Telco</h3>
        </div>
    </div>
    <div class="x_panel">
        <div class="x_title">
        <h2>Report Sales by Telco</h2>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0;">
        <div class="x_panel">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                SelectCommand="SELECT  convert(char(10),createdts,111) Date, [ReloadTelco], sum(ReloadAmount) as TotalSales FROM [TxIn]WHERE ((Status = 'SUCCESS') or  (Status = 'PENDING')) and datepart(mm,createdts)=@month and datepart(yyyy,createdts)=@year&#13;&#10;group by convert(char(10),createdts,111), [ReloadTelco]&#13;&#10;order by convert(char(10),createdts,111) , ReloadTelco">
                <SelectParameters>
