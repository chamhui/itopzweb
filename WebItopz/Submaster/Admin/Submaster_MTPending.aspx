<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="Submaster_MTPending.aspx.vb" Inherits="WebItopz.Submaster_Admin_MTPending" title="MTPending" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPreRender="GridView1_PreRender"
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="MTPending.aspx?ID={0}&amp;action=DeleteMT"
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" OnPreRender="GridView2_PreRender"
        ...
        ForeColor="Black" GridLines="Vertical" Style="margin: 10px" AllowPaging="True" CssClass="datatable-responsive table table-striped table-bordered dt-responsive nowrap">
        <FooterStyle BackColor="#CCCC99" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
        SelectCommand="SELECT ID, MessageOut, MSISDN, CreatedTS, Retry, Status, Robin FROM TxOut WHERE (Status = @Status) order by ID Desc">
        <SelectParameters>
