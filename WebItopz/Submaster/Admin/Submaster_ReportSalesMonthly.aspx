<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="Submaster_ReportSalesMonthly.aspx.vb" Inherits="WebItopz.Submaster_Admin_ReportSalesMonthly" title="ReportSalesMonthly" %>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0;">
        <div class="x_panel">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                SelectCommand="SELECT month(CreatedTS) AS Month, ReloadTelco, sum(ReloadAmount) as TotalSales FROM [TxIn] where month(createdts)=@month and year(CreatedTS) = @year and status = 'success' Group By ReloadTelco, month(CreatedTS) order by sum(ReloadAmount) desc ">
                <SelectParameters>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12" style="padding-right: 0;">
        <div class="x_panel">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                SelectCommand="SELECT month(CreatedTS) AS Month, ReloadTelco, sum(ReloadAmount) as TotalSales FROM [TxIn] where month(createdts)=(@month-1) and year(CreatedTS) = @year and status = 'success' Group By ReloadTelco, month(CreatedTS) order by sum(ReloadAmount) desc ">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DDLMonth" Name="month" PropertyName="SelectedValue" />
                    <asp:ControlParameter ControlID="DDLYear" Name="year" PropertyName="SelectedValue" />
                </SelectParameters>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0;">
        <div class="x_panel">
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                SelectCommand="SELECT month(CreatedTS) AS Month, ReloadTelco, sum(ReloadAmount) as TotalSales FROM [TxIn] where month(createdts)=(@month-2) and year(CreatedTS) = @year and status = 'success' Group By ReloadTelco, month(CreatedTS) order by sum(ReloadAmount) desc ">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DDLMonth" Name="month" PropertyName="SelectedValue" />
                    <asp:ControlParameter ControlID="DDLYear" Name="year" PropertyName="SelectedValue" />
                </SelectParameters>
