...
options.deCodeBehindName        | function | decode from UTF-8 | the function to decode the file name / comment.
...
zip.load(content, {
    deCodeBehindName: function (bytes) {
