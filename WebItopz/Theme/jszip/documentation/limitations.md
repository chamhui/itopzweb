...
You can use the [enCodeBehindName]({{site.baseurl}}/documentation/api_jszip/generate.html)
option and the [deCodeBehindName]({{site.baseurl}}/documentation/api_jszip/load.html)
