<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" Inherits="WebItopz.Dealer_AgentInfo" title="AgentInfo" Codebehind="AgentInfo.aspx.vb" %>
...
<script language="javascript">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
        ...
        UpdateCommand="UPDATE AgentInfo SET Name = @Name, Status = @Status WHERE (AgentID = @original_AgentID)">
        <DeleteParameters>
