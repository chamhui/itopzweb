<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" Inherits="WebItopz.DealerTopup" title="Agent Topup" Codebehind="AgentTopup.aspx.vb" %>
        ...
        <div class="form-horizontal form-label-left" >        
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <span style="font-size: 10pt">Your balance:</span>
                    <asp:Label ID="lblMyBalance" runat="server" Font-Size="Small" Text="0"></asp:Label>    
                </div>
            </div>                       
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
            ...
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name" style="float:left;">Amount <span style="color: #cc0000; font-size: 16px; margin-left: 1px; display: block; float: right;">*</span>
                </label>
                <div class="col-md-8 col-sm-8 col-xs-12">
