...
Partial Class DealerTopupCard
	...
	Protected Sub btnConfirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnConfirm.Click
		...
		If ProcessTopup(Me.DDLAgentID.SelectedValue, Me.txtMaxisAmount.Text) Then
			...
			Call LogAgentTopupTx(Session("DEALER_ID"), "0", "0", "Transfer to agentid " & DDLAgentID.SelectedValue & " via Web", "TRANSFERRED", ddlCard.SelectedValue, "-" & txtMaxisAmount.Text, txtPrice.Text)
			If LogAgentTopupTx(Me.DDLAgentID.SelectedValue, "0", "0", "Receive from agentid " & Session("DEALER_ID") & " via web. " & txtRemarks.Text, "RECEIVED", ddlCard.SelectedValue, "-" & txtMaxisAmount.Text, txtPrice.Text) Then
	...
	Private Function ProcessTopup(ByVal sAgentId As String, ByVal sTopUpAmount As String) As Boolean
		...
		Try
			...
			If (ddlCard.SelectedValue = "M5") Then
				sSQL = "UPDATE AgentBalance SET M5=M5+@TopUpAmount WHERE AgentId=@AgentId "
			ElseIf (ddlCard.SelectedValue = "M18") Then
				sSQL = "UPDATE AgentBalance SET M18=M18+@TopUpAmount WHERE AgentId=@AgentId "
			ElseIf (ddlCard.SelectedValue = "M28") Then
				sSQL = "UPDATE AgentBalance SET M28=M28+@TopUpAmount WHERE AgentId=@AgentId "
			End If
	...
	Private Function LogAgentTopupTx(ByVal sAgentId As String, ByVal sAmount As String, ByVal sBankIn As String, ByVal sRemarks As String, ByVal sType As String, ByVal sReloadType As String, ByVal sQuantity As String, ByVal sReloadAmount As String) As Boolean
		...
		Try
			...
			sSQL = "INSERT INTO AgentTopupTx (AgentId, Amount, BankIn, Remarks, Status,ReloadType,Quantity,ReloadAmount) VALUES (@AgentId, @Amount, @BankIn, @Remarks, @Status,@ReloadType,@Quantity,@ReloadAmount)"
