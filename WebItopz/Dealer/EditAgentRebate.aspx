<%@ Page Language="VB" AutoEventWireup="false" Inherits="WebItopz.DealerEditAgentRebate" Codebehind="EditAgentRebate.aspx.vb" %>
...
<body style="background: none;">
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" OnPreRender="GridView1_PreRender" 
            DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" style="width:100%;"
            BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" Height="1px" CssClass="datatable-responsive table table-striped table-bordered dt-responsive">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
            ...
            <UpdateParameters>
                <asp:Parameter Name="Rebate" Type="Decimal" />
