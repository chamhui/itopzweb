    ...
    Private Function SendGroupMT(ByVal sGroup As String) As Boolean
        ...
        Try
            ...
            If sGroup = "DEALER" Then
                sSQL = "SELECT i.HPNo AS MSISDN, i.AgentID FROM AgentInfo AS i INNER JOIN AgentBalance AS b ON i.AgentID = b.AgentID WHERE (i.Status = 'ACTIVE') AND i.ParentAgentID = '6'"
