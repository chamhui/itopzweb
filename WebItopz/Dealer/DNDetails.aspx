<%@ Page Language="VB" AutoEventWireup="false" Inherits="WebItopz.DealerDNDetails" Codebehind="DNDetails.aspx.vb" %>
...
<body style="background: none;">
    ...
    <div style="margin:10px;">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="LightGoldenrodYellow"
            BorderColor="Tan" BorderWidth="1px" CellPadding="2" DataSourceID="SqlDataSource1" OnPreRender="GridView1_PreRender"
            ...
            <Columns>
                ...
                DataNavigateUrlFormatString="DNDetails1.aspx?ReloadMSISDN={0}&amp;ReloadAmount={1}&amp;DN={2}"
                DataTextField="DNRefNo" HeaderText="DNRefNo" Target="_blank" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
            SelectCommand="SELECT TOP (10) DNTS, DNRefNo, DNReceivedId, CreatedTS, ReloadMSISDN, ReloadAmount, DNStatus FROM DNReceived WHERE (DNReceivedID = @DNReceivedID)">
            <SelectParameters>
