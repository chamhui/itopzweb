...
Partial Class Admin_UploadTopUp
    ...
    Private Function ExtractData(ByVal sFileName As String) As Boolean
        ...
        Try
            ...
            sSQL = "INSERT INTO TxIn(LocalMoID, MSISDN, AgentID, MessageTS, ReloadMSISDN, ReloadAmount, ReloadTelco, ReloadType, Robin, Retry) " & _
