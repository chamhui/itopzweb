<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="ReportAgentSalesSummary.aspx.vb" Inherits="WebItopz.ReportAgentSalesSummary" title=" ReportAgentSalesSummary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-title">
        <div class="title_left">
            <h3>Report Agent Sales</h3>
        </div>
    </div>
    <div class="x_panel">
        <div class="x_title">
        <h2>Report Agent Sales</h2>
        ...
        <div class="form-horizontal form-label-left" >                  
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12"> 
                    <asp:TextBox ID="txtAgentID" runat="server" class="form-control col-md-7 col-xs-12"></asp:TextBox>
                </div>
            </div>
           <div class="item form-group col-md-7 col-sm-7 col-xs-12">
 ...
 <%--   <div class="col-md-2 col-sm-2 col-xs-12">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="dataTable table-bordered table-counter"
            DataSourceID="SqlDataSource6" ForeColor="#333333" GridLines="None" Style="margin: 10px; width: 100%;" onrowdatabound="GridView5_RowDataBound"
					ShowFooter="true">
            <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
            <RowStyle BackColor="#FFFBD6" ForeColor="#333333"  />
            <Columns>
			 ...
			 <ItemTemplate>
				<div style="">
				<asp:Label ID="lblqty" runat="server" Text='<%# Eval("Total") %>' />
				</div>
			 </ItemTemplate>
			 <FooterTemplate>
				<div style="">
			 ...
			 <FooterTemplate>
				 	<div style="">
				<asp:Label ID="lblTotalComission" runat="server" />
				</div>
			 </FooterTemplate>
		  </asp:TemplateField>
            </Columns>
	 ...
	 <div class="col-md-12 col-sm-12 col-xs-12">
			 <h3>STARHUB</h3>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="dataTable table-bordered table-counter"
            DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Style="margin: 10px; width: 100%;"
	 ...
	 <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="dataTable table-bordered table-counter"
            DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" Style="margin: 10px; width: 100%;"
  ...
  <%--  <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
            SelectCommand="SELECT T.MSISDN, T.ReloadAmount, T.ReloadMSISDN, T.LastUpdatedTS, T.MessageIn, T.Status, R.BalanceAfterReload FROM TxIn AS T INNER JOIN TxReload AS R ON T.LocalMOID = R.LocalMOID COLLATE Chinese_Taiwan_Stroke_CI_AS WHERE (T.AgentID = @AgentID) AND (LEFT (T.MessageTS, 8) >= @MessageTS) AND (LEFT (T.MessageTS, 8) <= @MessageTS2) ORDER BY T.MessageTS DESC">
            <SelectParameters>
 ...
 <%--   <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                    SelectCommand="SELECT sum([ReloadAmount]) as Total FROM [TxIn] WHERE ((left([MessageTS],8) >= @MessageTS) AND (left([MessageTS],8) <= @MessageTS1) AND ([Status] = @Status)) and AgentId=@AgentId">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="txtDateFrom" Name="MessageTS" PropertyName="Text"
                            Type="String" />
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                    SelectCommand="SELECT ReloadTelco , sum([ReloadAmount]) as Total FROM [TxIn] WHERE ((left([MessageTS],8) >= @MessageTS) AND (left([MessageTS],8) <= @MessageTS1) AND ([Status] = @Status)) and AgentId=@AgentId&#13;&#10;group by ReloadTelco ">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="txtDateFrom" Name="MessageTS" PropertyName="Text" />
        ...
        SelectCommand="SELECT Balance,M5, M18,M28  FROM [AgentBalance] WHERE ([AgentID] = @AgentID)">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="txtAgentID" Name="AgentID" PropertyName="Text" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>--%>
<%--    <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
        SelectCommand="SELECT * FROM TxReload INNER JOIN TxIn ON TxReload.LocalMOID COLLATE Chinese_Taiwan_Stroke_CI_AS = TxIn.LocalMOID">
                ...
                <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                    SelectCommand="SELECT ReloadTelco, sum([ReloadAmount]) as Total FROM [TxIn] WHERE ((left([MessageTS],8) >= @MessageTS) AND (left([MessageTS],8) <= @MessageTS1) AND ([Status] = @Status)) and AgentId=@AgentId GROUP BY ReloadTelco&#13;&#10;">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="txtDateFrom" Name="MessageTS" PropertyName="Text" />
                        <asp:ControlParameter ControlID="txtDateTo" Name="MessageTS1" PropertyName="Text" />
                        <asp:Parameter DefaultValue="SUCCESS" Name="Status" Type="String" />
	   ...
	   <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                    SelectCommand="SELECT  ReloadAmount, sum([ReloadAmount]) as Total,count([ReloadAmount]) as Quantity, sum(ReloadAmount * Commission) as Commission FROM [TxIn] WHERE ((left([MessageTS],8) >= @MessageTS) AND (left([MessageTS],8) <= @MessageTS1) AND ([Status] = @Status) AND (ReloadTelco=@ReloadTelco)) and AgentId=@AgentId GROUP BY MSISDN, ReloadAmount&#13;&#10;order by ReloadAmount">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="txtDateFrom" Name="MessageTS" PropertyName="Text" />
                        <asp:ControlParameter ControlID="txtDateTo" Name="MessageTS1" PropertyName="Text" />
                        <asp:Parameter DefaultValue="SUCCESS" Name="Status" Type="String" />
											 <asp:Parameter DefaultValue="M1" Name="ReloadTelco" Type="String" />
                        <asp:ControlParameter ControlID="txtAgentID" Name="AgentID" PropertyName="Text" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
	   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="txtDateTo" Name="MessageTS1" PropertyName="Text" />
                        <asp:Parameter DefaultValue="SUCCESS" Name="Status" Type="String" />
											 <asp:Parameter DefaultValue="STARHUB" Name="ReloadTelco" Type="String" />
                        <asp:ControlParameter ControlID="txtAgentID" Name="AgentID" PropertyName="Text" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
	   <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="txtDateTo" Name="MessageTS1" PropertyName="Text" />
                        <asp:Parameter DefaultValue="SUCCESS" Name="Status" Type="String" />
											 <asp:Parameter DefaultValue="SINGTEL" Name="ReloadTelco" Type="String" />
                        <asp:ControlParameter ControlID="txtAgentID" Name="AgentID" PropertyName="Text" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
