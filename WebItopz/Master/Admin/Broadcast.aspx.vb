...
Partial Class Admin_Broadcast
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		If Page.IsPostBack Then
			...
			If Me.txtMSISDN.Text <> "" Then
				...
				End If
			Else
				If SendGroupMT(Me.DDLGroup.SelectedValue) Then
	...
	Private Sub AddGroup()
		...
		Try
			...
			sSQL = "SELECT i.HPNo AS MSISDN, i.AgentID,i.Name FROM AgentInfo AS i INNER JOIN AgentBalance AS b ON i.AgentID = b.AgentID WHERE (i.Status = 'ACTIVE') AND i.ParentAgentID=0"
			...
			While oDR.Read
				DDLGroup.Items.Add(New ListItem(oDR.Item("AgentID").ToString + " - " + oDR.Item("Name").ToString, oDR.Item("AgentID")))
			End While
			oDR.Close()
	...
	Private Function SendGroupMT(ByVal sGroup As String) As Boolean
        ...
        Try
			...
			Else
				sSQL = "SELECT i.HPNo AS MSISDN, i.AgentID FROM AgentInfo AS i INNER JOIN AgentBalance AS b ON i.AgentID = b.AgentID WHERE (i.Status = 'ACTIVE') AND (i.ParentAgentID=" + sGroup + " or i.AgentID=" + sGroup + ")"
			End If
