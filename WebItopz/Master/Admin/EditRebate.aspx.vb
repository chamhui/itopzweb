...
Partial Class EditRebate
    ...
    Protected Sub btnEditRebate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEditRebate.Click
		...
		ElseIf (Me.DDLRebate.Text) < -30 Or (Me.DDLRebate.Text) > 100 Then
			Me.lblErrorMsg2.Text = "Invalid Rebate Amount (Max 100%)! "
		Else
	...
	Protected Sub btnAddRebate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddRebate.Click
		...
		ElseIf (Me.txtRebate.Text) < -30 Or (Me.txtRebate.Text) > 100 Then
			Me.lblErrorMsg.Text = "Invalid Rebate Amount (Max 100%)! "
		Else
			If CheckDenomination(Session("ProductID"), txtDenomination.Text) Then
				Me.lblErrorMsg.Text = "Denomination already exits!"
			ElseIf AddRebate(Session("ProductID"), txtDenomination.Text, txtRebate.Text, txtP_FaceValue.Text) Then
	...
	Private Function AddRebate(ByVal sProductID As String, ByVal sDenomination As String, ByVal sRebate As String, ByVal P_FaceValue As String) As Boolean
		...
		Try
			sSQL = "INSERT INTO ProductRebate (ProductID,Denomination,Rebate, P_FaceValue ) VALUES (@ProductID,@Denomination,@Rebate, @P_FaceValue )"
			...
			oCmd.Parameters.Add(New SqlParameter("@P_FaceValue", P_FaceValue))
	...
	Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GridView1.RowUpdating
		...
		Dim tFaceValue As TextBox = GridView1.Rows(e.RowIndex).FindControl("txtP_FaceValue")
		...
		Dim P_FaceValue As String = tFaceValue.Text.Trim
		...
		ElseIf Not IsNumeric(sRebate) Then
			Me.lblErrorMsg.Text = "Invalid Rebate! "
		ElseIf (sRebate) < -30 Or (sRebate) > 100 Then
			Me.lblErrorMsg.Text = "Invalid Rebate Amount (Max 100%)! "
		Else
			If CheckDenomination(Session("ProductID"), sDenomination, sRebateID) Then
				Me.lblErrorMsg.Text = "Denomination already exits!"
			ElseIf UpdateProductRebate(sRebateID, sDenomination, sRebate, P_FaceValue) Then
	...
	Private Function UpdateProductRebate(ByVal sRebateID As String, ByVal sDenomination As String, ByVal sRebate As String, ByVal P_FaceValue As String) As Boolean
		...
		Try
			sSQL = "UPDATE ProductRebate SET Denomination=@Denomination,Rebate=@Rebate, P_FaceValue=@P_FaceValue WHERE RebateID=@RebateID"
