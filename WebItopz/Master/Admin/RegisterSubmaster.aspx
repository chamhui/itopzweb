<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="RegisterSubmaster.aspx.vb" Inherits="WebItopz.RegisterSubmaster" title="Register Sub Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <span style="text-decoration: underline"></span>
    <div class="page-title">
        <div class="title_left">
            <h3>Register New Sub Master</h3>
        </div>
    </div>
    <div class="x_panel">
        <div class="x_title">
