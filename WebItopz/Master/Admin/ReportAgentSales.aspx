<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="ReportAgentSales.aspx.vb" Inherits="WebItopz.ReportAgentSales" title=" ReportAgentSales" EnableEventValidation="false"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
            SelectCommand="SELECT T.MSISDN, T.ReloadAmount, T.ReloadMSISDN, T.LastUpdatedTS, T.MessageIn, T.Status, R.BalanceAfterReload, T.ReloadTelco FROM TxIn AS T INNER JOIN TxReload AS R ON T.LocalMOID = R.LocalMOID COLLATE Chinese_Taiwan_Stroke_CI_AS WHERE (T.AgentID = @AgentID) AND (LEFT (T.MessageTS, 8) >= @MessageTS) AND (LEFT (T.MessageTS, 8) <= @MessageTS2) ORDER BY T.MessageTS DESC">
            <SelectParameters>
