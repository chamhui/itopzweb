<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="ReportTopAgent.aspx.vb" Inherits="WebItopz.Admin_ReportTopAgent" title="ReportTopAgent" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0;">
        <div class="x_panel">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RichTechConnectionString %>"
                SelectCommand="SELECT month(CreatedTS) AS Month,(SELECT ParentAgentID FROM AgentInfo AS i WHERE (AgentID = b.AgentID)) AS ParentAgentID, (SELECT Name FROM AgentInfo AS i WHERE (AgentID = b.AgentID)) AS Name, AgentID, sum(ReloadAmount) as TotalSales FROM [TxIn] AS b where month(createdts)=@month and year(CreatedTS) = @year and status = 'success' and (ReloadTelco != 'IndiaFlexi' and reloadtelco != 'BDFlexi') Group By AgentID, month(CreatedTS) order by sum(ReloadAmount) desc ">
                <SelectParameters>
    ...
    SelectCommand="SELECT month(CreatedTS) AS Month,(SELECT ParentAgentID FROM AgentInfo AS i WHERE (AgentID = b.AgentID)) AS ParentAgentID, (SELECT Name FROM AgentInfo AS i WHERE (AgentID = b.AgentID)) AS Name, AgentID, sum(ReloadAmount) as TotalSales FROM [TxIn] AS b where month(createdts)=(@month-1) and year(CreatedTS) = @year and status = 'success' and (ReloadTelco != 'IndiaFlexi' and reloadtelco != 'BDFlexi') Group By AgentID, month(CreatedTS) order by sum(ReloadAmount) desc ">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DDLMonth" Name="month" PropertyName="SelectedValue" />
                    <asp:ControlParameter ControlID="DDLYear" Name="year" PropertyName="SelectedValue" />
                </SelectParameters>
    ...
    SelectCommand="SELECT month(CreatedTS) AS Month,(SELECT ParentAgentID FROM AgentInfo AS i WHERE (AgentID = b.AgentID)) AS ParentAgentID, (SELECT Name FROM AgentInfo AS i WHERE (AgentID = b.AgentID)) AS Name, AgentID, sum(ReloadAmount) as TotalSales FROM [TxIn] AS b where month(createdts)=(@month-2) and year(CreatedTS) = @year and status = 'success' and (ReloadTelco != 'IndiaFlexi' and reloadtelco != 'BDFlexi') Group By AgentID, month(CreatedTS) order by sum(ReloadAmount) desc ">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DDLMonth" Name="month" PropertyName="SelectedValue" />
                    <asp:ControlParameter ControlID="DDLYear" Name="year" PropertyName="SelectedValue" />
                </SelectParameters>
