<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="RegisterRetailer.aspx.vb" Inherits="WebItopz.Admin_RegisterRetailer" title="Register Retailer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <span style="text-decoration: underline"></span>
    <div class="page-title">
        <div class="title_left">
            <h3>Register New Retailer</h3>
        </div>
    </div>
    <div class="x_panel">
        <div class="x_title">
        <h2>Register New Retailer</h2>
