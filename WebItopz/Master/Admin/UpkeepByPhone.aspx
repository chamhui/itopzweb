<%@ Page Title="UpkeepTx2" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="UpkeepByPhone.aspx.vb" Inherits="WebItopz.UpkeepByPhone" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    ...
    <br />
            <h2>M1</h2>
          <table id="datatable0" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                      ...
                      <tbody>
              <asp:Repeater ID="rptrUpkeepM1" runat="server">
                  <ItemTemplate>
                  <tr>
  ...
  <br />
      ...
      <table id="datatable1" class="table table-striped table-bordered">
                      ...
                      <tbody>
              <asp:Repeater ID="rptrUpkeepStarhub" runat="server">
                  <ItemTemplate>
                  <tr>
...
<th>5GB</th>
                      ...
                      <tbody>
              <asp:Repeater ID="rptrUpkeepSingtel" runat="server">
                  <ItemTemplate>
                  <tr>
