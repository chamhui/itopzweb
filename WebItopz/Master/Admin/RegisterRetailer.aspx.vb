...
Partial Class Admin_RegisterRetailer
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        Else
            ...
            msRetailer = "yes"
            If InsertNewAgent(msNEWAgentID, txtName.Text, Me.txtHPno.Text, msRetailer) Then
    ...
    Private Function InsertNewAgent(ByVal sNewAgentId As String, ByVal sName As String, ByVal sHPno As String, ByVal sRetailer As String) As Boolean
        ...
        Try
            sSQL = "INSERT INTO AgentInfo (AgentID, Name, HPNo, Retailer) VALUES (@AgentId,@Name, @HPNo, @Retailer)"
            ...
            oCmd.Parameters.Add(New SqlParameter("@Retailer", sRetailer))
