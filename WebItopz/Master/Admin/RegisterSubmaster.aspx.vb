...
Partial Class RegisterSubmaster
	...
	Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
		...
		Else
			...
			If InsertNewAgent(msNEWAgentID, txtName.Text, Me.txtHPno.Text, "|1|") Then
	...
	Private Function InsertNewAgent(ByVal sNewAgentId As String, ByVal sName As String, ByVal sHPno As String, ByVal sAgentlvl As String) As Boolean
		...
		Try
			sSQL = "INSERT INTO AgentInfo (AgentID, Name, HPNo,Agentlvl ) VALUES (@AgentId,@Name, @HPNo, @Agentlvl )"
			...
			oCmd.Parameters.Add(New SqlParameter("@Agentlvl", sAgentlvl))
	...
	Private Function InsertAgentBalance(ByVal sNewAgentId As String) As Boolean
		...
		Try
			sSQL = "INSERT INTO AgentBalance (AgentID) VALUES (@AgentId)"
