<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="PrintReports.aspx.vb" Inherits="WebItopz.PrintReports" title="PrintReports" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Button ID="btnPrintReportAgentTopUpAll" runat="server" class="btn btn-success" Text="PrintReportAgentTopUpAll"/><br />
     <br />
   &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
   <asp:Button ID="btnSimCardBalance" runat="server" class="btn btn-success" Text="ReportSImCardBalance" />
