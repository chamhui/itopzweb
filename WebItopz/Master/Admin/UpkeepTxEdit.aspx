<%@ Page Title="Upkeep" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="UpkeepTxEdit.aspx.vb" Inherits="WebItopz.UpkeepTxEdit" %>
        ...
        <div class="form-horizontal form-label-left" >
            ...
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
             ...
             <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel5" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>  
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel10" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>  
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel20" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>  
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel50" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>  
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel16" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>  
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel15" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>  
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel28" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>  
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel300" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>  
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel180" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>  
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel888" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div> 
            ...
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel102" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div> 
            ...
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel1015" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>
            ...
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel118" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>
            ...
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel1315" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>
            ...
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel119" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>
            ...
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel2504" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>
            ...
            <div class="item form-group col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <asp:TextBox ID="txtSingtel120" runat="server" class="form-control col-md-7 col-xs-12" ></asp:TextBox>      
                </div><label class="control-label col-md-1 col-sm-3 col-xs-12" for="name"> 
                </label>
            </div>
            ...
            <div class="item form-group col-md-7 col-sm-7 col-xs-12" style="text-align:center;">
                ...
                <asp:Button ID="btnDelete" runat="server" cssClass="btn btn-success" Text="Delete" OnClick="btnDelete_Click" />
